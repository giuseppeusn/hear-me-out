  ...
  function renderList($musica, $list) {
    if ($musica) {
        ...
        while ($data = $list->fetch_object()) {
            $html .= coverCard($data->musica_nome, $data->musica_capa, '/hear-me-out/projeto/musica?id=' . $data->musica_id . '', $data->musica_duracao, true, $data->musica_id, $data->musica_data);
        }
