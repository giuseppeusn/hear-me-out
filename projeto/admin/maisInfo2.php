...
<body>
    <div class="container mt-2 pb-4 border-bottom">
        <div class="py-2">
            <a href='index.php?page=2' class='btn btn-danger mb-3'>Voltar</a>
        </div>
        <div class="row">
            <div class="col">
    ...
    <div class="container pt-4 ps-5">
        ...
        <div class="row py-3 cor border-bottom">
            <div class="col-2 fw-bold">CPF:</div>
            <div class="col">
                <?php echo $resultado_array['cpf'] ?>
            </div>
        </div>
        <div class="row py-3 border-bottom">
            <div class="col-2 fw-bold">Data de Nascimento:</div>
            <div class="col">
                <?php echo $resultado_array['data_nasc'] ?>
            </div>
        </div>
        <div class="row py-3 cor border-bottom">
        ...
        <div class="row py-3 border-bottom">
            <div class="col-2 fw-bold">Gênero:</div>
            <div class="col">
                <?php
                switch ($resultado_array['genero']) {
                    case 'M':
                        echo "Masculino";
                        break;
                    case 'F':
        ...
        <div class="row py-3 cor rounded-bottom">
            <div class="col-2 fw-bold">Portifólio:</div>
            <div class="col">
                <?php echo $resultado_array['site'] ?>
            </div>
        </div>
        <div class="row py-3">
            <a href="criticosAdmin.php?id=<?php echo $id; ?>&aprovado=1" class="btn btn-success aprovar-link custom-btn-size p-1">Aprovar</a>
        </div>
    </div>
    </div>
